...
if ($result->num_rows > 0) {
    ...
    fputcsv($fp, array('customers_id', 'platform_name', 'customers_company', 'customers_name', 'customers_last_name','customers_first_name', 'camera_payment_status', 'cameras_purchased', 'date_cam_purchased', 'customer_paid_up_cam_orders'));
